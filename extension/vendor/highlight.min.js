...
variants:[{begin:"/",end:"/[a-z]*"},{begin:"%r{",end:"}[a-z]*"},{begin:"%r\\(",
end:"\\)[a-z]*"},{begin:"%r!",end:"![a-z]*"},{begin:"%r\\[",end:"\\][a-z]*"}]
}].concat(r),relevance:0}].concat(r);b.contains=l,g.contains=l;var o=[{
begin:/^\s*=>/,starts:{end:"$",contains:l}},{className:"meta",
